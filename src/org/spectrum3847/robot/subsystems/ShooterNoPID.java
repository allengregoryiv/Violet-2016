...
public class ShooterNoPID extends Subsystem {
	...
	public ShooterNoPID(String n, SpectrumSpeedController sc, double maxVal, double minVal){
		super(n);
		speedController = sc;
		max = maxVal;
		min = minVal;
	...
	public ShooterNoPID(String n, int scPWM, int scPDP, double maxVal, double minVal){
		this(n, new SpectrumSpeedController(new Talon(scPWM), scPDP), maxVal, minVal);
	}
	
	public ShooterNoPID(String n, int scPWM, int scPDP){
		this(n, new SpectrumSpeedController(new Talon(scPWM), scPDP), 1, -1);
	}
	
	public ShooterNoPID(String n, SpectrumSpeedController sc){
		this(n, sc, 1, -1);
	}
